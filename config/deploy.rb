...
set :wp_user, "joel" # The admin username
set :wp_email, "joelataylor@gmail.com" # The admin email address
set :wp_sitename, "Joel A Taylor" # The site title
set :wp_localurl, "https://joelataylor.com" # Your local environment URL

############################################
# Setup project
############################################

set :application, "joelataylor"
set :repo_url, "git@github.com:joelataylor/joelataylor.git"
set :scm, :git
